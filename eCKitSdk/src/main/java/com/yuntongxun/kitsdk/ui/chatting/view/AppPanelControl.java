...
public class AppPanelControl {
	...
	public int[] cap = new int[] { R.string.app_panel_pic,
			...
			R.string.app_panel_call,R.string.app_panel_p2pvideo
	...
	private Capability getCapability(int resid) {
		...
		} else if (resid == R.string.app_panel_call) {
			capability = new Capability(getContext().getString(R.string.app_panel_call),
					R.drawable.im_icon_call);
		} else if (resid == R.string.app_panel_p2pvideo) {
			capability = new Capability(getContext().getString(R.string.app_panel_p2pvideo),
					R.drawable.im_icon_video);
		}
