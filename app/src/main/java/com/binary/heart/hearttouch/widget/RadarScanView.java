...
/**
 * Created by yaoguoju on 2015/8/19.
 */
public class RadarScanView extends View
{
    ...
    private int circleColor = Color.parseColor("#faffffff");
    ...
    private void init(AttributeSet attrs, Context context)
    {
        ...
        defaultWidth = dip2px(context, width);
        defaultHeight = dip2px(context, width);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        canvas.drawCircle(centerX, centerY, 3 * radarRadius / 6, mPaintCircle);

        //设置颜色渐变从透明到不透明
        //        Shader shader = new SweepGradient(centerX, centerY, Color.TRANSPARENT, tailColor);
        Shader shader = new SweepGradient(centerX, centerY, Color.parseColor("#00ff5454"),
            Color.parseColor("#ffc71f09"));
        mPaintRadar.setShader(shader);
        canvas.concat(matrix);
        canvas.drawCircle(centerX, centerY, 3 * radarRadius / 6, mPaintRadar);
    }
