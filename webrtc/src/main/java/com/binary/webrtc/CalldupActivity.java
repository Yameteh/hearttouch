...
import com.binary.webrtc.util.SignalingManager;
 ...
 * and call view.
 */
public class CalldupActivity extends Activity implements SignalingManager.SignalingEvents,
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    SignalingManager.SM.registerSignalingEvents(this);
...
//    }
    ...
    peerConnectionClient.createPeerConnectionFactory(
        getApplicationContext(), peerConnectionParameters, CalldupActivity.this);
  ...
  private void startCall() {
    ...
    onConnectedToRoom(SignalingManager.SM.getSignalingParmeters());
  }
  ...
  private void disconnect() {
    SignalingManager.SM.setSignalingParameters(null);
    activityRunning = false;
  ...
  public void onLocalDescription(final SessionDescription sdp) {
    ...
    runOnUiThread(new Runnable() {
      ...
      public void run() {
          ...
          if (signalingParameters.initiator) {
            SignalingManager.SM.sendOfferSdp(sdp);
          } else {
            SignalingManager.SM.sendAnswerSdp(sdp);
          }
  ...
  public void onIceCandidate(final IceCandidate candidate) {
    runOnUiThread(new Runnable() {
      @Override
      public void run() {
          SignalingManager.SM.sendLocalIceCandidate(candidate);
      }
    });
  }
  ...
  public void onIceCandidatesRemoved(final IceCandidate[] candidates) {
    runOnUiThread(new Runnable() {
      @Override
      public void run() {
        SignalingManager.SM.sendLocalIceCandidateRemovals(candidates);
      }
    });
  }
