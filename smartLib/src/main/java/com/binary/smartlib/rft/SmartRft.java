package com.binary.smartlib.rft;
 ...
 *
 */
public class SmartRft {
        private final static String TAG = "SmartRft";
	    /**
	     * 
	     * @title: setField
	    ...
	    public static void setFieldAll(Object owner, String fieldName, Object value) throws Exception {
	        ...
	        for (Class<?> clazz = ownerClass; clazz != Object.class; clazz = clazz.getSuperclass()) {
	            try {
	                ...
	                SmartLog.d(TAG,field + " find : in " + clazz.getName());
	                break;
	            }
	            catch (Exception e) {
	            	SmartLog.d(TAG,fieldName + " not find in " + clazz.getName());
	            }
	        }
	        field.setAccessible(true);
	        field.set(owner, value);
		 ...
		 * @return
		 */
		public static Field[] getFields(Object owner) throws Exception{
			Class<?> ownerClass = owner.getClass();
			return ownerClass.getDeclaredFields();
		}
	    ...
	    public static Object invokeMethodAll(Object owner, String methodName, Object... args) throws Exception {
	        ...
	        for (Class<?> clazz = ownerClass; clazz != Object.class; clazz = clazz.getSuperclass()) {
	            try {
	                ...
	                SmartLog.d(TAG,method + " find : in " + clazz.getName());
	                return method;
	            }
	            catch (Exception e) {
	                //e.printStackTrace();
	            	SmartLog.d(TAG,methodName + " not find in " + clazz.getName());
	            }
	        }
	        method.setAccessible(true);
	        return method.invoke(owner, args);
